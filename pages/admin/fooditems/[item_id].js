...
const EditItem = () => {
  ...
  const fooditem = JSON.parse(localStorage.getItem("toEdit"));
  ...
  const [mediaUrl, setMediaUrl] = useState(fooditem.mediaUrl);
  ...
  const editFoodItem = async (e) => {
    ...
    if (res2.error) {
      ...
      toast.success("Fooditem Edited Successfully!,Redirecting to Menu Page.", {
        position: "top-right",
        autoClose: 4000,
        hideProgressBar: false,
        closeOnClick: true,
